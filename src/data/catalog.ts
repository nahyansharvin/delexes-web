...
export const categoryDetails: Record<string, CategoryDetail> = {
  'laboratory-equipment': {
    ...
    cataloguePdf: '/catalogues/lab-equipment.pdf',
    featured: [
      { name: 'Manual Pipette', description: 'Ergonomically designed pipette with a wide volume range and high accuracy. Fully autoclavable and resistant to chemical corrosion, making it ideal for laboratory applications.', image: null },
      { name: 'Electronic Pipette', description: 'Advanced pipetting solution offering precise liquid handling with reduced manual effort. Designed for consistent performance in high-throughput laboratory environments.', image: null },
      { name: 'Centrifuge', description: 'High-performance centrifuge designed for efficient sample separation. Suitable for a wide range of laboratory and research applications.', image: null },
      { name: 'Magnetic Hotplate Stirrer', description: 'Combines heating and stirring functions for uniform mixing of solutions. Ideal for chemical and biological laboratory processes.', image: null },
      { name: 'Overhead Stirrer', description: 'Powerful stirring device designed for high-viscosity samples. Ensures stable and consistent mixing in laboratory environments.', image: null },
      { name: 'Water Bath', description: 'Provides precise temperature control for sample incubation and heating. Commonly used in microbiology and biochemical applications.', image: null },
      { name: 'Compact Incubator', description: 'Space-efficient incubator designed for controlled temperature environments. Suitable for cell culture and microbiological studies.', image: null },
      { name: 'Microvolume Spectrophotometer', description: 'Enables accurate measurement of nucleic acids and proteins using minimal sample volumes. Ideal for molecular biology workflows.', image: null },
      { name: 'Fluorometer', description: 'Sensitive detection instrument for fluorescence-based assays. Used in DNA, RNA, and protein quantification.', image: null },
      { name: 'Microplate Reader', description: 'Versatile system for detecting biological, chemical, and physical events in microplate formats. Suitable for high-throughput screening.', image: null },
      { name: 'PCR System', description: 'Thermal cycler designed for DNA amplification with precise temperature control. Essential for molecular biology and genetic research.', image: null },
      { name: 'CO2 Incubator', description: 'Maintains optimal conditions for cell growth with controlled CO₂ levels, humidity, and temperature. Widely used in cell culture applications.', image: null },
    ],
    otherItems: [
